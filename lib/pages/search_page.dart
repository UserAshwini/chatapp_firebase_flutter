...
import 'package:chatapp_firebase_flutter/pages/chat_page.dart';
    ...
    if (searchSnapshot != null && searchSnapshot!.docs.isNotEmpty) {
      ...
      return const  Center(
        child:  Padding(
          ...
          child: Text("No such group found",style: TextStyle(fontSize: 21,fontWeight: FontWeight.w500,color: Colors.black),),
        ));
      
    }
  } else {
    return Container(); // You can return an empty container or loading indicator here.
  }
}
